...
app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://root:zl082006@127.0.0.1:3306/movie"
...
class Tag(db.Model):
    ...
    moives = db.relationship("Movie", backref="tag")  # 电影外键关系关联
...
class Admin(db.Model):
    ...
    addtime = db.Column(db.DateTime, index=True, default=datetime.utcnow)  # 添加时间
    adminlogs = db.relationship("Adminlog", backref="admin")  # 管理员登录关系关联
    oplogs = db.relationship("Oplog", backref="admin")  # 管理员操作关系关联
